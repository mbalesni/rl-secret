...
def save_experience(recording, directory):
...
@ click.option('--rec-frequency', type=int, default=4e3, help='experience recording frequency, episodes')
@ click.option('--rec-episodes', type=int, default=1e4, help='number of episodes to record at each recording')
...
def train(note, env_name, seed, log_frequency, rec_frequency, rec_episodes, episodes,
